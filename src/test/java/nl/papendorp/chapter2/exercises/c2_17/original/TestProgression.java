...
import nl.papendorp.chapter2.exercises.c2_17.original.ArithmeticProgression;
import nl.papendorp.chapter2.exercises.c2_17.original.FibonacciProgression;
import nl.papendorp.chapter2.exercises.c2_17.original.GeometricProgression;
import nl.papendorp.chapter2.exercises.c2_17.original.Progression;
import org.junit.jupiter.api.DisplayName;
import org.junit.jupiter.api.Test;

@DisplayName( "Test program for the progression hierarchy." )
class TestProgression
{
	@Test
	@DisplayName( "All of the given 'tests' in their given state. No refactoring done. " +
			"No assertions added. Will always pass." )
	void mainTest()
	{
		Progression prog;
