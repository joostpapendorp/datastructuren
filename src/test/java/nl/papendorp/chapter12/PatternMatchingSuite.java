...
public abstract class PatternMatchingSuite
{
	@Test
	...
	@Test
	@DisplayName( "only find continuous pattern occurrences" )
	void interrupted_pattern_occurrences_are_rejected()
	{
		dontFind( "abXcYZ", "XYZ" );
	}
	...
	protected abstract PatternMatcher sut();
}
